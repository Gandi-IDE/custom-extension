        ...
        constructor(runtime) {
            ...
            this._formatMessage = runtime.getFormatMessage({
                ...
                en: {
                    ...
                    'MotionPro.docs':'documentation',
                    'MotionPro.tip':'⚠only Compile Mode',
        ...
        getInfo(){
            return{
                ...
                blocks:[
                    {
                        blockType: "button",
                        text: this.formatMessage('MotionPro.docs'),
                        onClick: this.docs
                    },
                    {
                        blockType: Scratch.BlockType.LABEL,
                        text: this.formatMessage('MotionPro.tip')
                    },
                    {
                        blockType: 'button',
