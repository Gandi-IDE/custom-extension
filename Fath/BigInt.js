  ...
  window.tempExt = {
    ...
    info: {
      ...
      extensionId: 'bigint',
      iconURL: '/banners/bigint.svg',
      insetIconURL: '/assets/bigint.png',
      featured: true,
      disabled: false,
