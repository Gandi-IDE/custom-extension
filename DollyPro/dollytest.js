...
class dollyProExtension {
     ...
     */
		...
		const _hackedInitDrawable = function (layerGroup) {
			if (!this.isOriginal) {
				// 触发hat“当克隆体即将启动”
				this.runtime.startHats('dollyPro_initTheClone', null, this);
			}
		...
		this.fm = this.runtime.getFormatMessage({
			'zh-cn': {
				'dollyPro.name': '多莉Pro',
				'dollyPro.urlButton': '📖 扩展教程',
				'dollyPro.url': 'https://learn.ccw.site/article/',
				'dollyPro.tag.utils': '🔧 常用工具',
				'dollyPro.tag.event': '🔔 事件触发',
				'dollyPro.tag.cloneAndDelete': '🪄 克隆与删除',
				'dollyPro.tag.data': '📄 数据获取与设置',
				'dollyPro.tag.group': '📁 克隆体分组',
				'dollyPro.tag.motion': '🚶 运动相关',
				'dollyPro.tag.sensing': '🔍 侦测相关',
				'dollyPro.tag.test': '🚧 实验积木',
				'dollyPro.button.showBlock': '显示不常用的多莉积木',
				'dollyPro.button.hideBlock': '隐藏不常用的多莉积木',
				'dollyPro.confirm.showBlock?':
          '为了避免积木过多，一些不常用的多莉积木被隐藏了起来\n是否显示隐藏积木？',
				'dollyPro.block.addOrRemoveIDFromGroup':
          '将克隆体 [ID] [OP] [GROUP] 分组',
				'dollyPro.block.pickTarget': '点x:[X]y:[Y]处最上层克隆体ID',
				'dollyPro.block.addOrRemoveMyselfFromGroup':
          '将我 [OP] [GROUP] 分组',
				'dollyPro.block.calcDistanceBetweenClones':
          '克隆体1[ID1]到克隆体2[ID2]的[MENU]',
				'dollyPro.block.calcDistanceToClone': '到克隆体[ID]的[MENU]',
				'dollyPro.block.cancelAccessTransfer':
          '取消坐标/方向数据的访问转移',
				'dollyPro.block.cloneIDOfForEach': '⚠️当前遍历ID',
				'dollyPro.block.createCloneAndSpecifyID':
          '克隆 [TARGET] 并设置ID为 [ID]',
				'dollyPro.block.deleteCloneByID': '删除ID为[ID]的克隆体',
				'dollyPro.block.dispatchWhenCloneDeleted':
          '当 [TARGET] 的克隆体被删除，删除的克隆体ID = [ID]',
				'dollyPro.block.dispatchWhenCloned':
          '当 [TARGET] 被克隆，产生的克隆体ID = [ID]',
				'dollyPro.block.forEachWithGroup':
          '⚠️遍历[GROUP]分组的每个克隆体',
				'dollyPro.block.getClonePropertyInGroup':
          '[GROUP]分组第 [INDEX] 个克隆体的 [PROPERTY]',
				'dollyPro.block.getClonePropertyWithID':
          '克隆体 [ID] 的 [PROPERTY]',
				'dollyPro.block.getCloneTargetPropertyWithSpriteName':
          '[TARGET] 的克隆体的 [PROPERTY]',
				'dollyPro.block.getGroupInfo': '[GROUP] 分组的克隆体 [PROPERTY]',
				'dollyPro.block.getJustCreatedCloneID': '刚克隆的克隆体的ID',
				'dollyPro.block.getMyProperty': '我的 [PROPERTY]',
				'dollyPro.block.getMyValueByKey': '我的[KEY]',
				'dollyPro.block.getNearestClone':
          '[TYPE][MENU][VALUE]的克隆体的ID',
				'dollyPro.menu.nearest': '最近的',
				'dollyPro.menu.farthest': '最远的',
				'dollyPro.block.getOriginalTargetPropertyWithSpriteName':
          ' [TARGET] 的 [PROPERTY]',
				'dollyPro.block.getTouchingID':
          '碰到[MENU][VALUE]的[TYPE]克隆体的ID',
				'dollyPro.block.getValueOfCloneIDWithKey': '克隆体[ID]的[KEY]',
				'dollyPro.block.ifCloneExists': '存在ID为 [ID] 的克隆体？',
				'dollyPro.block.ifCloneInGroup': '克隆体 [ID] 属于[GROUP]分组？',
				'dollyPro.block.importGroupIntoList':
          '将[GROUP]分组中所有克隆体ID列表 [OP] 到列表 [LIST]',
				'dollyPro.block.importTouchingIDsIntoList':
          '将碰到的[MENU][VALUE]的所有克隆体的ID [OP] 到列表 [LIST]',
				'dollyPro.block.initTheClone': '当前克隆体启动的前一刻',
				'dollyPro.block.beforeDeletionOfTheClone':
          '当前克隆体删除的前一刻',
				'dollyPro.block.isCloneOrIsOriginal': '我是[TYPE]吗？',
				'dollyPro.block.isCloneTouchingCoord':
          '[MENU][VALUE]的克隆体碰到点x:[X]y:[Y]？',
				'dollyPro.block.isTouchingClone': '碰到[MENU][VALUE]的克隆体？',
				'dollyPro.block.isCloneTouchingClone':
          'ID[ID]碰到[MENU][VALUE]的克隆体？',
				'dollyPro.block.moveStepsToClone': '朝克隆体[ID][MOTION][VALUE]',
				'dollyPro.block.moveToClone': '[MOTION]克隆体[ID]',
				'dollyPro.block.presetDataforTheNextCloneInJSONFormat':
          '预设下个克隆体的数据为JSON[DATA_JSON]',
				'dollyPro.block.presetGroupForTheNextClone':
          '预设下个克隆体要加入的一个分组[GROUP]',
				'dollyPro.block.presetPropertyForTheNextClone':
          '预设下个克隆体的[PROPERTY]为[VALUE]',
				'dollyPro.block.presetSingleDataForTheNextClone':
          '预设下个克隆体数据[KEY]为[VALUE]',
				'dollyPro.block.setMyID': '⚠️将我的ID修改为[ID]',
				'dollyPro.block.setOrChangeMyValueWithKey':
          '将我的[KEY][OP][VALUE]',
				'dollyPro.block.setOrChangeValueOfCloneIDWithKey':
          '克隆体[ID]的[KEY][OP][VALUE]',
				'dollyPro.block.transferAccessToTargetXYToDollyDataKey':
          '将扩展中对角色坐标、方向的访问转移到对以下键数据访问：[X_NAME][Y_NAME][DIR_NAME](选填)',
				'dollyPro.block.broadcastToClone':
          '向[MENU][VALUE]克隆体发送私信[MSG]，内容为[data]',
				'dollyPro.block.receiveMyBroadcast':
          '当我接收到名为[MSG]的私信。私信内容=[data]，发送者ID=[senderID]',

				'dollyPro.defaultValue.MSGName': '信息1',
				'dollyPro.defaultValue.MSGInfo': '数据',
				'dollyPro.defaultValue.HP': '生命值',
				'dollyPro.defaultValue.direction': '方向',
				'dollyPro.defaultValue.enemy': '敌人',
				'dollyPro.defaultValue.player': '玩家',
				'dollyPro.defaultValue.presetJSON':
          '\'{"名称":"普通士兵","生命值":100,"阵营":"红色"}\'',
				'dollyPro.menu.addOrRemove.add': '加入',
				'dollyPro.menu.addOrRemove.remove': '移出',
				'dollyPro.menu.calcBetweenClones.absAngleDifference':
          '角度差(正数)',
				'dollyPro.menu.calcBetweenClones.angleDifference':
          '角度差(带符号)',
				'dollyPro.menu.calcBetweenClones.direction': '方向',
				'dollyPro.menu.calcBetweenClones.distance': '距离',
				'dollyPro.menu.cloneProperty.IDList': 'ID列表',
				'dollyPro.menu.cloneProperty.allSprite': '所有角色',
				'dollyPro.menu.cloneProperty.anySprite': '任意角色',
				'dollyPro.menu.cloneProperty.count': '数量',
				'dollyPro.menu.cloneProperty.json': 'JSON',
				'dollyPro.menu.cloneProperty.myself': '自己',
				'dollyPro.menu.dataop.change': '增加',
				'dollyPro.menu.dataop.set': '设为',
				'dollyPro.menu.listop.insert': '插入',
				'dollyPro.menu.listop.replace': '覆盖',
				'dollyPro.menu.miton.PointAt': '面向',
				'dollyPro.menu.miton.moveSteps': '移动步数',
				'dollyPro.menu.miton.moveTo': '移到',
				'dollyPro.menu.miton.rotateDegrees': '旋转角度',
				'dollyPro.menu.oneOrAll.all': '所有',
				'dollyPro.menu.oneOrAll.one': '一个',
				'dollyPro.menu.spriteProperty._size': '大小',
				'dollyPro.menu.spriteProperty._visible': '显示?',
				'dollyPro.menu.spriteProperty._x': 'x 坐标',
				'dollyPro.menu.spriteProperty._y': 'y 坐标',
				'dollyPro.menu.spriteProperty.currentCostume': '造型编号',
				'dollyPro.menu.spriteProperty.currentCostumeName': '造型名',
				'dollyPro.menu.spriteProperty.direction': '方向',
				'dollyPro.menu.spriteProperty.id': 'ID',
				'dollyPro.menu.spriteProperty.name': '角色名',
				'dollyPro.menu.spriteProperty.dataJSON': '附带数据JSON',
				'dollyPro.menu.targetType.ID': 'ID为',
				'dollyPro.menu.targetType.group': '分组',
				'dollyPro.menu.targetType.sprite': '角色',
				'dollyPro.menu.type.clone': '克隆体',
				'dollyPro.menu.type.original': '角色本体',
				'dollyPro.menu.color': '颜色特效',
				'dollyPro.menu.fisheye': '鱼眼特效',
				'dollyPro.menu.whirl': '旋涡特效',
				'dollyPro.menu.pixelate': '像素化特效',
				'dollyPro.menu.mosaic': '马赛克特效',
				'dollyPro.menu.brightness': '亮度特效',
				'dollyPro.menu.ghost': '虚像特效',

				'dollyPro.block.setCloneProperty':
          '克隆体[ID]的[PROPERTY][OP][VALUE]',
			},
			en: {
				'dollyPro.name': 'Dolly Pro',
				'dollyPro.urlButton': '📖 Tutorial',
				'dollyPro.url': 'https://learn.ccw.site/article/',
				'dollyPro.tag.utils': '🔧 Common Tools',
				'dollyPro.tag.event': '🔔 Event',
				'dollyPro.tag.cloneAndDelete': '🪄 Clone and Delete',
				'dollyPro.tag.data': '📄 Data Access',
				'dollyPro.tag.group': '📁 Clone Groups',
				'dollyPro.tag.motion': '🚶 Motion',
				'dollyPro.tag.sensing': '🔍 Sensing',
				'dollyPro.tag.test': '🚧 Experimental Blocks',
				'dollyPro.button.showBlock': 'show other blocks',
				'dollyPro.button.hideBlock': 'hide other blocks',
				'dollyPro.confirm.showBlock?':
          'To avoid clutter, some infrequently used blocks are hidden.\nDo you want to show hidden blocks?',
				'dollyPro.block.addOrRemoveIDFromGroup':
          'clone [ID] [OP] group [GROUP] ',
				'dollyPro.block.pickTarget': 'ID of the top-most at x:[X]y:[Y]',
				'dollyPro.block.addOrRemoveMyselfFromGroup':
          'myself [OP] group [GROUP]',
				'dollyPro.menu.addOrRemove.add': 'add to',
				'dollyPro.menu.addOrRemove.remove': 'remove from',
				'dollyPro.block.calcDistanceBetweenClones':
          '[MENU] from clone1[ID1] to clone2[ID2]',
				'dollyPro.menu.calcBetweenClones.direction': 'direction',
				'dollyPro.menu.calcBetweenClones.distance': 'distance',
				'dollyPro.menu.calcBetweenClones.absAngleDifference':
          'angular difference (postive)',
				'dollyPro.menu.calcBetweenClones.angleDifference':
          'angular difference (signed)',
				'dollyPro.block.calcDistanceToClone': '[MENU] to clone[ID]',
				'dollyPro.block.cancelAccessTransfer':
          'cancel the transfer of coordinate/direction data access',
				'dollyPro.block.cloneIDOfForEach': '⚠️current clone ID',
				'dollyPro.block.createCloneAndSpecifyID':
          'create clone of [TARGET] and set ID to[ID]',
				'dollyPro.block.deleteCloneByID': 'delete clone[ID]',
				'dollyPro.block.dispatchWhenCloneDeleted':
          ...
          '[PROPERTY] of [TARGET]\'s clones',
				'dollyPro.block.getGroupInfo':
          '[PROPERTY] of clones in group [GROUP]',
				'dollyPro.block.getJustCreatedCloneID':
          'just created clone\'s ID',
				'dollyPro.block.getMyProperty': 'my [PROPERTY]',
				'dollyPro.block.getMyValueByKey': 'my[KEY]',
				'dollyPro.block.getNearestClone':
          'get [TYPE] clone\'s ID[MENU][VALUE]',
				'dollyPro.menu.nearest': 'nearest',
				'dollyPro.menu.farthest': 'farthest',
				'dollyPro.menu.targetType.ID': 'with ID',
				'dollyPro.menu.targetType.group': 'in group',
				'dollyPro.menu.targetType.sprite': 'of sprite',
				'dollyPro.block.getOriginalTargetPropertyWithSpriteName':
          '[PROPERTY] of [TARGET]',
				'dollyPro.block.getTouchingID':
          '[TYPE][MENU][VALUE]I\'m touching',
				'dollyPro.menu.oneOrAll.all': 'IDs of all clones',
				'dollyPro.menu.oneOrAll.one': 'ID of one clone',
				'dollyPro.block.getValueOfCloneIDWithKey': '[KEY]of clone[ID]',
				'dollyPro.block.ifCloneExists': 'clone[ID]exists?',
				'dollyPro.block.ifCloneInGroup':
          'clone [ID] belongs to group[GROUP]?',
				'dollyPro.block.importGroupIntoList':
          '[OP]list[LIST]with IDs of clones in group[GROUP]',
				'dollyPro.menu.listop.insert': 'insert',
				'dollyPro.menu.listop.replace': 'replace',
				'dollyPro.block.importTouchingIDsIntoList':
          '[OP]list[LIST]with IDs of clones[MENU][VALUE]I\'m touching',
				'dollyPro.block.initTheClone': 'before I start as a clone',
				'dollyPro.block.beforeDeletionOfTheClone':
          'before I\'m deleted as a clone',
				'dollyPro.block.isCloneOrIsOriginal': 'am I [TYPE]?',
				'dollyPro.menu.type.clone': 'a clone',
				'dollyPro.menu.type.original': 'the original sprite',
				'dollyPro.block.isCloneTouchingCoord':
          'clone[MENU][VALUE]touching x:[X]y:[Y]?',
				'dollyPro.block.isTouchingClone':
          'touching a clone[MENU][VALUE]',
				'dollyPro.block.isCloneTouchingClone':
          'clone[ID]touching a clone[MENU][VALUE]',
				'dollyPro.block.moveStepsToClone':
          '[MOTION][VALUE]towards clone[ID]',
				'dollyPro.menu.miton.moveSteps': 'move steps',
				'dollyPro.menu.miton.rotateDegrees': 'turn degrees',
				'dollyPro.block.moveToClone': '[MOTION]clone[ID]',
				'dollyPro.menu.miton.PointAt': 'point towards',
				'dollyPro.menu.miton.moveTo': 'go to',
				'dollyPro.block.presetDataforTheNextCloneInJSONFormat':
          ...
          'preset [KEY] of the next clone to [VALUE]',
				'dollyPro.block.setMyID': '⚠️modify my ID to[ID]',
				'dollyPro.block.setOrChangeMyValueWithKey': 'my[KEY][OP][VALUE]',
				'dollyPro.block.setOrChangeValueOfCloneIDWithKey':
          '[KEY]of clone[ID][OP][VALUE]',
				'dollyPro.menu.dataop.change': 'change by',
				'dollyPro.menu.dataop.set': 'set to',
				'dollyPro.block.transferAccessToTargetXYToDollyDataKey':
          'transfer access to sprite coordinates and direction in the extension to the following key data: [X_NAME], [Y_NAME], [DIR_NAME] (optional)',
				'dollyPro.defaultValue.HP': 'health point',
				'dollyPro.defaultValue.direction': 'direction',
				'dollyPro.defaultValue.enemy': 'enemy',
				'dollyPro.defaultValue.player': 'player',
				'dollyPro.defaultValue.presetJSON':
          '\'{"name":"common soldier ","HP":100,"team":"red"}\'',
				'dollyPro.menu.cloneProperty.IDList': 'list of IDs',
				'dollyPro.menu.cloneProperty.allSprite': 'all sprites',
				'dollyPro.menu.cloneProperty.anySprite': 'any sprite',
				'dollyPro.menu.cloneProperty.count': 'number',
				'dollyPro.menu.cloneProperty.json': 'JSON',
				'dollyPro.menu.cloneProperty.myself': 'myself',
				'dollyPro.menu.spriteProperty._size': 'size',
				'dollyPro.menu.spriteProperty._visible': 'visible?',
				'dollyPro.menu.spriteProperty._x': 'x position',
				'dollyPro.menu.spriteProperty._y': 'y position',
				'dollyPro.menu.spriteProperty.currentCostume': 'costume number',
				'dollyPro.menu.spriteProperty.currentCostumeName':
          'costume name',
				'dollyPro.menu.spriteProperty.direction': 'direction',
				'dollyPro.menu.spriteProperty.id': 'ID',
				'dollyPro.menu.spriteProperty.name': 'sprite name',
				'dollyPro.menu.spriteProperty.dataJSON': 'data in JSON format',
				'dollyPro.menu.color': 'color effect',
				'dollyPro.menu.fisheye': 'fisheye effect',
				'dollyPro.menu.whirl': 'whirl effect',
				'dollyPro.menu.pixelate': 'pixelate effect',
				'dollyPro.menu.mosaic': 'mosaic effect',
				'dollyPro.menu.brightness': 'brightness effect',
				'dollyPro.menu.ghost': 'ghost effect',
          ...
          'when I receive private message[MSG] for me. data=[data]，senderID=[senderID]',
				'dollyPro.defaultValue.MSGName': 'message1',
				'dollyPro.defaultValue.MSGInfo': 'data',
				'dollyPro.block.setCloneProperty':
	...
	getHats() {
		return {
			'dollyPro_dispatchWhenCloned': {},
			'dollyPro_dispatchWhenCloneDeleted': {},
			'dollyPro_initTheClone': {},
			'dollyPro_beforeDeletionOfTheClone': {},
			'dollyPro_receiveMyBroadcast': {},
		};
	}
   ...
   */
	...
	__processCloneBeforeCreation(target) {
		...
		// 广播克隆体产生的hat
		this.runtime.startHatsWithParams('dollyPro_dispatchWhenCloned', {
			parameters: { ID },
...
window.tempExt = {
	...
	info: {
		name: 'dollyPro.extensionName',
		description: 'dollyPro.description',
		extensionId,
		iconURL: cover,
		insetIconURL: icon,
		featured: true,
	...
	l10n: {
		'zh-cn': {
			'dollyPro.extensionName': '🐏多莉 Pro',
			'dollyPro.description': '✨ 更好的克隆体管理',
		},
		en: {
			'dollyPro.extensionName': '🐏Dolly Pro',
			'dollyPro.description': '✨ Enhanced clone management',
		},
	},
};
