...
class KukeMCI18n {
  constructor(runtime) {
    ...
    this.i18n = {
      ...this._initialedI18n?.locales?.en,
    };
    this.supportedTranslateCode = [
      ["阿尔巴尼亚语", "Albanian", "sq"],
      ["阿拉伯语", "Arabic", "ar"],
      ["阿姆哈拉语", "Amharic", "am"],
      ["阿丘雅语", "Achuar", "acu"],
    ...
    this._formatMessage = runtime.getFormatMessage({
      ...
      en: {
        ...
        "kukeMCI18n.tip.allSupportedLanguages": "Supports [NUM] languages in total",
      },
    });
  }
  ...
  getInfo() {
    ...
    const printSupportedLanguages = {
      ...
      onClick: () => {
        ...
        this.runtime.logSystem.info(this.formatMessage("kukeMCI18n.tip.allSupportedLanguages").replace('[NUM]', this.supportedTranslateCode.length));
      },
    };
    const translateText = {
    ...
    return {
      ...
      menus: {
        ...
        TRANSLATE_LIST: {
          ...
          items: this.supportedTranslateCode.map((t) => {
            return {
              text: `${t[0]}(${t[1]})`,
              value: t[2],
            };
  ...
  docs() {
    ...
    a.href = "https://learn.ccw.site/article/99e0432c-98f2-4394-8a32-e501beee1e27";
  ...
  initI18nForURL({ URL }) {
    ...
    if (xhr.status === 200) {
      ...
      console.error(`[kukeMCI18n] request i18n failed: `);
    }
  }
...
window.tempExt = {
  ...
  info: {
    ...
    doc: "https://www.ccw.site/post/d6d96e80-3f58-4a19-b7e6-c567d3a6a583",
  ...
  l10n: {
    ...
    en: {
      "kukeMCI18n.name": "I18n",
      "kukeMCI18n.description":
        "This game internationalization extension simplifies adding multi-language support to your game.",
    },
  },
};
