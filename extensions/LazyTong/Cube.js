...
void (window.tempExt = {
    Extension: class {
        constructor(e) {
            ...
            this.instances = {}, this.runtime = e, this.canvas = () => {
                try {
                    const {
                        canvas: e
                ...
                let tau = 2 * Math.PI,
                    ...
                    canvasRenderer = {};
                canvasRenderer.begin = function (e) {
                    e.beginPath()
                }, canvasRenderer.move = function (e, t, a) {
                    e.moveTo(a.x, a.y)
                }, canvasRenderer.line = function (e, t, a) {
                    e.lineTo(a.x, a.y)
                }, canvasRenderer.bezier = function (a, r, o, d, e) {
                    a.bezierCurveTo(o.x, o.y, d.x, d.y, e.x, e.y)
                }, canvasRenderer.closePath = function (e) {
                    e.closePath()
                }, canvasRenderer.setPath = function () {
                }, canvasRenderer.renderPath = function (d, a, t, r) {
                    this.begin(d, a), t.forEach(function (e) {
                        e.render(d, a, canvasRenderer)
                    }), r && this.closePath(d, a)
                }, canvasRenderer.stroke = function (a, r, o, d, e) {
                    o && (a.strokeStyle = d, a.lineWidth = e, a.stroke())
                }, canvasRenderer.fill = function (t, a, r, o) {
                    r && (t.fillStyle = o, t.fill())
                }, canvasRenderer.end = function () {
                };
                let vector = function (e) {
                    this.set(e)
                };
                vector.prototype.set = function (e) {
                    return this.x = e && e.x || 0, this.y = e && e.y || 0, this.z = e && e.z || 0, this
                }, vector.prototype.write = function (e) {
                    return e ? (this.x = null == e.x ? this.x : e.x, this.y = null == e.y ? this.y : e.y, this.z = null == e.z ? this.z : e.z, this) : this
                }, vector.prototype.rotate = function (e) {
                    if (e) return this.rotateZ(e.z), this.rotateY(e.y), this.rotateX(e.x), this
                }, vector.prototype.rotateZ = function (e) {
                    R(this, e, 'x', 'y')
                }, vector.prototype.rotateX = function (e) {
                    R(this, e, 'y', 'z')
                }, vector.prototype.rotateY = function (e) {
                    R(this, e, 'x', 'z')
                };
                ...
                vector.prototype.isSame = function (e) {
                ...
                }, vector.prototype.transform = function (e, t, a) {
                    return this.multiply(a), this.rotate(t), this.add(e), this
                }, vector.prototype.lerp = function (a, e) {
                    return this.x = lerp(this.x, a.x || 0, e), this.y = lerp(this.y, a.y || 0, e), this.z = lerp(this.z, a.z || 0, e), this
                ...
                anchor.prototype.create = function (e) {
                    this.children = [], extend(this, this.constructor.defaults), this.setOptions(e), this.translate = new vector(e.translate), this.rotate = new vector(e.rotate), this.scale = new vector(onePoint).multiply(this.scale), this.origin = new vector, this.renderOrigin = new vector, this.addTo && this.addTo.addChild(this)
                }, anchor.defaults = {}, anchor.optionKeys = Object.keys(anchor.defaults).concat(['rotate', 'translate', 'scale', 'addTo']), anchor.prototype.setOptions = function (e) {
                    let t = this.constructor.optionKeys;
                    for (let a in e) -1 !== t.indexOf(a) && (this[a] = e[a])
                }, anchor.prototype.addChild = function (e) {
                    -1 !== this.children.indexOf(e) || (e.remove(), e.addTo = this, this.children.push(e))
                }, anchor.prototype.removeChild = function (a) {
                ...
                }, anchor.prototype.transform = function (t, a, r) {
                ...
                }, anchor.shapeSorter = function (a, e) {
                ...
                }, anchor.prototype.addChildFlatGraph = function (e) {
                ...
                }, anchor.prototype.renderGraphCanvas = function (a) {
                    if (!a) console.error('Cube: 未提供渲染上下文');
                    this.flatGraph.forEach(function (e) {
                        e.render(a, canvasRenderer)
                    })
                }, anchor.prototype.copy = function (e) {
                    let a = {},
                    ...
                    return new o(a)
                }, anchor.prototype.copyGraph = function (e) {
                    let a = this.copy(e);
                    ...
                    this.rotate.x = modulo(this.rotate.x, tau), this.rotate.y = modulo(this.rotate.y, tau), this.rotate.z = modulo(this.rotate.z, tau)
                };
                let d = function (e) {
                    return function (a) {
                        let r = function (e) {
                        ...
                        return r.prototype = Object.create(e.prototype), r.prototype.constructor = r, r.defaults = extend({}, e.defaults), extend(r.defaults, a), r.optionKeys = e.optionKeys.slice(0), Object.keys(r.defaults).forEach(function (t) {
                            1 !== !r.optionKeys.indexOf(t) && r.optionKeys.push(t)
                        }), r.subclass = d(r), r
                    }
                };
                anchor.subclass = d(anchor);
                ...
                let dragger = function (e) {
                    this.create(e || {})
                };
                dragger.prototype.create = function (t) {
                ...
                }, dragger.prototype.bindDrag = function (t) {
                    t = this.getQueryElement(t), t && (t.style.touchAction = 'none', t.addEventListener(e, this))
                }, dragger.prototype.getQueryElement = function (e) {
                    return 'string' == typeof e && (e = document.querySelector(e)), e
                }, dragger.prototype.handleEvent = function (a) {
                    let e = this['on' + a.type];
                    e && e.call(this, a)
                }, dragger.prototype.onmousedown = dragger.prototype.onpointerdown = function (e) {
                    this.dragStart(e, e)
                }, dragger.prototype.ontouchstart = function (e) {
                    this.dragStart(e, e.changedTouches[0])
                }, dragger.prototype.dragStart = function (e, t) {
                ...
                }, dragger.prototype.ontouchmove = function (e) {
                    this.dragMove(e, e.changedTouches[0])
                }, dragger.prototype.onmousemove = dragger.prototype.onpointermove = function (e) {
                    this.dragMove(e, e)
                }, dragger.prototype.dragMove = function (t, a) {
                    t.preventDefault();
                ...
                extend(init.prototype, dragger.prototype), init.prototype.create = function (e) {
                    anchor.prototype.create.call(this, e), dragger.prototype.create.call(this, e), this.setElement(this.element), this.setDragRotate(this.dragRotate), this.setResize(this.resize)
                }, init.prototype.setElement = function (e) {
                    if (!this.element) console.error('Cube: 未指定元素');
                    this.setCanvas(e)
                    ...
                    e = e || this, this.prerenderCanvas(), anchor.prototype.renderGraphCanvas.call(e, this.ctx), this.postrenderCanvas()
                    ...
                    this.dragStartRX = this.dragRotate.rotate.x, this.dragStartRY = this.dragRotate.rotate.y, dragger.prototype.dragStart.apply(this, arguments)
                    ...
                    this.dragRotate.rotate.x = this.dragStartRX - e / t * tau, this.dragRotate.rotate.y = this.dragStartRY - d / t * tau, dragger.prototype.dragMove.apply(this, arguments)
                };
                let D = function (e) {
                    return e instanceof vector ? e : new vector(e)
                }, M = function (e) {
                    return new vector(e)
                }, w = function (e, t) {
                    this.method = e, this.points = t.map(D), this.renderPoints = t.map(M), this.previousPoint = this.endRenderPoint = this.renderPoints[this.renderPoints.length - 1], 'arc' === e && (this.controlPoints = [new vector, new vector])
                };
                ...
                custom.prototype.create = function (e) {
                    this.path = e.path;
                    anchor.prototype.create.call(this, e);
                    this.updatePath();
                    this.front = new vector(e.front || this.front);
                ...
                custom.prototype.updatePath = function () {
                    ...
                    if (this.visible && a && (this.isFacingBack = 0 < this.renderNormal.z, this.backface || !this.isFacingBack)) {
                        if (!t) console.error('Cube: 未提供渲染器');
                    ...
                    if (a) {
                        ...
                        t.beginPath(), t.arc(r.x, r.y, a / 2, 0, tau), t.fill()
                    }
                    ...
                    return a ? this.backface : this.color
                ...
                y.prototype.updateSortValue = function () {
                    ...
                    }), this.sortValue = r / this.flatGraph.length, this.updateSort && this.flatGraph.sort(anchor.shapeSorter)
                ...
                let roundedRect = custom.subclass({
                    width: 1,
                    height: 1,
                    cornerRadius: .25,
                    closed: false
                ...
                hemisphere.prototype.create = function () {
                    ellipse.prototype.create.apply(this, arguments), this.apex = new anchor({
                        addTo: this,
                        translate: {
                            z: this.diameter / 2
                        }
                ...
                cone.prototype.create = function () {
                    ...
                    }), this.renderApex = new vector, this.renderCentroid = new vector, this.tangentA = new vector, this.tangentB = new vector, this.surfacePathCommands = [new w('move', [{}]), new w('line', [{}]), new w('line', [{}])]
                    ...
                    if (this.visible) {
                        ...
                        let r = this.renderNormal.magnitude(),
                            ...
                            i = this.diameter / 2 * r;
                        if (i * n < T) {
                            let c = Math.atan2(this.renderNormal.y, this.renderNormal.x) + tau / 2,
                                e = Math.acos(i / (T / n)),
                                t = this.tangentA,
                                a = this.tangentB;
                ...
                let box = anchor.subclass(Z);
                return box.prototype.create = function (e) {
                    anchor.prototype.create.call(this, e), this.updatePath(), this.fill = this.fill
                    ...
                    init: args => new init(args),
                    createCustom: args => new custom(args),
                    createRect: args => new rect(args),
                    createRoundedRect: args => new roundedRect(args),
                    createEllipse: args => new ellipse(args),
                    createPolygon: args => new polygon(args),
                    createHemisphere: args => new hemisphere(args),
                    createCylinder: args => new cylinder(args),
                    createCone: args => new cone(args),
                    createBox: args => new box(args)
                }
            }(), (null === this.canvas()) && console.error('Cube: 无法定位到舞台'), (() => {
                if (null !== this.canvas() && null !== this.parentElement()) {
                    let id = 'cube_' + Math.floor(16777215 * Math.random()).toString(16);
                    let t = document.createElement('canvas');
                    t.setAttribute('id', id), t.setAttribute('width', this.canvas().style.width), t.setAttribute('height', this.canvas().style.height);
                    let a = t.style;
                    a.position = 'absolute', a.left = '0%', a.top = '0%', a.pointerEvents = 'none', this.parentElement().appendChild(t), this.stage = this.renderer.init({
                        element: document.getElementById(id)
                    }), new MutationObserver(() => {
                        if (document.getElementById(id) == null) this.parentElement().appendChild(t)
                    }).observe(document.body, {
                        childList: true,
                        subtree: true
                    }), new MutationObserver(() => {
                        for (let a in t.setAttribute('width', this.canvas().style.width), t.setAttribute('height', this.canvas().style.height), this.cubeScene = this.renderer.init({
                            element: document.getElementById(id)
                        }), this.instances) this.stage.addChild(this.instances[a]);
                        this.stage.updateRenderGraph()
                    }).observe(this.canvas(), {
                        attributes: true
                    })
                }
            ...
            this._formatMessage = e.getFormatMessage({
                'zh-cn': {
                    ...
                    'Cube.y': 'Y',
                    'Cube.z': 'Z',
                    'Cube.rotateX': '在X上旋转的角度',
                    'Cube.rotateY': '在Y上旋转的角度',
                    'Cube.rotateZ': '在Z上旋转的角度',
                    'Cube.width': '宽度',
                    'Cube.height': '高度',
                    'Cube.color': '颜色',
                    'Cube.stroke': '大小',
                ...
                en: {
                    ...
                    'Cube.y': 'Y',
                    'Cube.z': 'Z',
                    'Cube.rotateX': 'the angle of rotation on X',
                    'Cube.rotateY': 'the angle of rotation on Y',
                    'Cube.rotateZ': 'the angle of rotation on Z',
                    'Cube.width': 'width',
                    'Cube.height': 'height',
                    'Cube.color': 'color',
                    'Cube.stroke': 'stroke',
                    ...
                    'Cube.refreshBlocks': 'Refresh blocks',
        ...
        getInfo() {
            ...
            return {
                ...
                blocks: [{
                    ...
                    blockType: 'button',
                    text: this.formatMessage('Cube.refreshBlocks'),
                    onClick: () => {
                ...
                menus: {
                    attrib: [{
                        ...
                        text: this.formatMessage('Cube.rotateX'),
                        value: 'rotateX'
                    }, {
                        text: this.formatMessage('Cube.rotateY'),
                        value: 'rotateY'
                    }, {
                        text: this.formatMessage('Cube.rotateZ'),
                        value: 'rotateZ'
                    }, {
        ...
        createRect(args) {
            null !== this.canvas() && null !== this.parentElement() && (void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0), this.instances[args.id] = this.renderer.createRect({
                width: +args.width,
                height: +args.height,
            ...
            }), this.stage.addChild(this.instances[args.id]))
        }

        createRoundedRect(args) {
            null !== this.canvas() && null !== this.parentElement() && (void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0), this.instances[args.id] = this.renderer.createRoundedRect({
                width: +args.width,
                height: +args.height,
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : '#' + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createCircle(args) {
            null !== this.canvas() && null !== this.parentElement() && (void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0), this.instances[args.id] = this.renderer.createEllipse({
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : '#' + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createPolygon(args) {
            null !== this.canvas() && null !== this.parentElement() && (void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0), this.instances[args.id] = this.renderer.createPolygon({
                sides: +args.sides,
                radius: +args.sides,
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : '#' + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createHemisphere(args) {
            null !== this.canvas() && null !== this.parentElement() && (void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0), this.instances[args.id] = this.renderer.createHemisphere({
                diameter: +args.diameter,
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : '#' + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createCone(args) {
            null !== this.canvas() && null !== this.parentElement() && (void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0), this.instances[args.id] = this.renderer.createCone({
                diameter: +args.diameter,
                stroke: +args.stroke / 100,
                length: +args.length,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : '#' + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createCylinder(args) {
            null !== this.canvas() && null !== this.parentElement() && (void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0), this.instances[args.id] = this.renderer.createCylinder({
                diameter: +args.diameter,
                stroke: +args.stroke / 100,
                length: +args.length,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : '#' + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createBox(args) {
            null !== this.canvas() && null !== this.parentElement() && (void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0), this.instances[args.id] = this.renderer.createBox({
                width: +args.width,
                height: +args.height,
                depth: +args.depth,
                stroke: +args.stroke / 100,
        ...
        createCustom(args) {
            null !== this.canvas() && args.path !== 'fileListEmpty' && null !== this.parentElement() && '{}' !== args.path && (void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0), this.instances[args.id] = this.renderer.createCustom({
                stroke: +args.stroke / 100,
                closed: (() => {
                    switch (args.closed) {
                        case true:
                ...
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : '#' + Math.floor(16777215 * Math.random()).toString(16))(),
                path: JSON.parse(String.fromCharCode.apply(null, this.runtime.getGandiAssetById(args.path).asset.data)),
                translate: {
                    x: +args.x,
                    y: +args.y,
                    z: +args.z
        ...
        deleteObject(args) {
            null !== this.parentElement() && void 0 !== this.instances[args.id] && (this.stage.removeChild(this.instances[args.id]), this.instances[args.id] = void 0)
        }

        deleteAllObject() {
            if (null !== this.parentElement()) {
                for (let e in this.instances) this.stage.removeChild(this.instances[e]);
                this.instances = {}
            }
        }
        ...
        getAttrib(args) {
            try {
                if (void 0 !== typeof this.instances[args.id]) switch (args.type) {
                    case 'x':
                        return 'undefined' == typeof this.instances[args.id].translate.x ? 'NaN' : this.instances[args.id].translate.x;
                    case 'y':
                        return 'undefined' == typeof this.instances[args.id].translate.y ? 'NaN' : this.instances[args.id].translate.y;
                    case 'z':
                        return 'undefined' == typeof this.instances[args.id].translate.z ? 'NaN' : this.instances[args.id].translate.z;
                    case 'rotateX':
                        return 'undefined' == typeof this.instances[args.id].rotate.x ? 'NaN' : this.instances[args.id].rotate.x * (180 / Math.PI);
                    case 'rotateY':
                        return 'undefined' == typeof this.instances[args.id].rotate.y ? 'NaN' : this.instances[args.id].rotate.y * (180 / Math.PI);
                    case 'rotateZ':
                        return 'undefined' == typeof this.instances[args.id].rotate.z ? 'NaN' : this.instances[args.id].rotate.z * (180 / Math.PI);
                    case 'width':
                        return 'undefined' == typeof this.instances[args.id].width ? 'NaN' : this.instances[args.id].width;
                    case 'height':
                        return 'undefined' == typeof this.instances[args.id].height ? 'NaN' : this.instances[args.id].height;
                    case 'color':
                        return 'undefined' == typeof this.instances[args.id].color ? 'NaN' : this.instances[args.id].color;
                    case 'stroke':
                        return 'undefined' == typeof this.instances[args.id].stroke ? 'NaN' : this.instances[args.id].stroke;
                    case 'quarters':
                        return 'undefined' == typeof this.instances[args.id].quarters ? 'NaN' : this.instances[args.id].quarters;
                    case 'cornerRadius':
                        return 'undefined' == typeof this.instances[args.id].cornerRadius ? 'NaN' : this.instances[args.id].cornerRadius;
                    case 'radius':
                        return 'undefined' == typeof this.instances[args.id].radius ? 'NaN' : this.instances[args.id].radius;
                    default:
                        return 'NaN';
                }
            } catch (e) {
        ...
        setRotate(args) {
            if (void 0 !== typeof this.instances[args.id]) switch (args.type) {
                case 'x':
                    this.instances[args.id].rotate.x = +args.rotate * (Math.PI / 180);
                    break;
                case 'y':
                    this.instances[args.id].rotate.y = +args.rotate * (Math.PI / 180);
                    break;
                case 'z':
                    this.instances[args.id].rotate.z = +args.rotate * (Math.PI / 180);
                    break;
                default:
                    break;
            }
