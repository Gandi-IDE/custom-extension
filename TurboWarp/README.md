Extensions below are ported from [TurboWarp](https://github.com/TurboWarp/extensions), which may have licenses different from other extensions in the repository. Thanks for their contributions!  
