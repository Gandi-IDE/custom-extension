    ...
    constructor(runtime) {
        ...
        this._formatMessage = runtime.getFormatMessage({
            'zh-cn': {
                ...
                'Three.block.newV3fromValue': '从[value]创建向量3D',
                'Three.block.getAxisOfV3': '获取向量[vector]的[axis]轴',
                ...
                'Three.block.rotateAroundPointV3': '将向量[a]绕[b]点旋转[yaw][pitch][roll]',
                'Three.block.rotateAroundCenterV3': '将向量[a]绕中心点旋转[yaw][pitch][roll]',
                'Three.block.newV2': '向量2D x:[x] y:[y]',
                'Three.block.newV2fromValue': '从[value]创建向量2D',
                'Three.block.getAxisOfV2': '获取向量[vector]的[axis]轴',
                'Three.block.project2DFromCam': '从相机将[a]投影到2D',
                'Three.block.project2DFromPos': '从[yaw]、[pitch]和[roll]将[a]投影到2D，从[b]点',
                ...
                'Three.block.cam3DsetPosition': '将相机设置位置为[a]并[cam]',
                'Three.block.cam3DchangePosition': '将相机位置更改[a]并[cam]',
                'Three.block.cam3DchangePositionOnAxis': '将相机在[axis]轴上移动[a]并[cam]',
                'Three.block.cam3DgetPosition': '获取相机位置',
                'Three.block.cam3DsetRotation': '将相机设置旋转为[a]并[cam]',
                'Three.block.cam3DchangeRotation': '将相机旋转增加[a]并[cam]',
                'Three.block.cam3DchangeRotationOnAxis': '将相机绕[rotator]旋转增加[a]并[cam]',
                'Three.block.cam3DgetRotation': '获取相机旋转',
                'Three.block.setFov': '将FOV设置为[dist]并[cam]',
                'Three.block.changeFov': '将FOV增加[dist]并[cam]',
            ...
            en: {
                ...
                'Three.block.mulV3': 'V3: [a] * [b]',
                'Three.block.divV3': 'V3: [a] / [b]',
                'Three.block.dotProductOfV3': 'V3: dot product between [a] and [b]',
                'Three.block.crossProductOfV3': 'V3: cross product between [a] and [b]',
                ...
                'Three.block.mulV2': 'V2: [a] * [b]',
                'Three.block.divV2': 'V2: [a] / [b]',
                'Three.block.dotProductOfV2': 'V2: dot product between [a] and [b]',
                'Three.block.crossProductOfV2': 'V2: cross product between [a] and [b]',
