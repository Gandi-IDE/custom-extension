    ...
    constructor(runtime) {
        ...
        this._formatMessage = runtime.getFormatMessage({
            'zh-cn': {
                ...
                'Three.block.rotateAroundPointV3': '将向量[a]绕[yaw]、[pitch]和[roll]旋转，绕[b]点',
                'Three.block.rotateAroundCenterV3': '将向量[a]绕[yaw]、[pitch]和[roll]旋转，绕中心点',
                ...
                'Three.block.setFov': '将视野设置为[dist]并[cam]',
                'Three.block.changeFov': '将视野增加[dist]并[cam]',
                'Three.block.getFov': '视野',
