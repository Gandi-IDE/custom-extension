        ...
        constructor(runtime) {
            ...
            this._formatMessage = runtime.getFormatMessage({
                "zh-cn": {
                    ...
                    'OperatorsPro.docs':'文档',
                    'OperatorsPro.tip':'⚠仅支持编译模式',
                    ...
                    'OperatorsPro.lengthofstringorArray':'字符串或数组长度',
                ...
                en: {
                    ...
                    'OperatorsPro.docs':'documentation',
                    'OperatorsPro.tip':'⚠only Compile Mode',
                    ...
                    'OperatorsPro.lengthofstringorArray':'length of string or Array',
        ...
        getInfo(){
            return{
                ...
                blocks:[
                    {
                        blockType: "button",
                        text: this.formatMessage('OperatorsPro.docs'),
                        onClick: this.docs,
                    },
                    {
                        blockType: Scratch.BlockType.LABEL,
                        text: this.formatMessage('OperatorsPro.tip'),
                    },
                    {
                        blockType: 'button',
                ...
                menus:{
                    ...
                    numericalvalue:{
                        ...
                        items: [
                            ...
                            {
                                text: this.formatMessage('OperatorsPro.lengthofstringorArray'),
                                value: 1
                            }
                        ]
                    },
    ...
    window.tempExt = {
        ...
        l10n: {
            "zh-cn": {
                ...
                "OperatorsPro.descp": "为运行添绿化：数学课作弊神器！"
            },
            en: {
                "OperatorsPro.name": "Operation pro",
                "OperatorsPro.descp": "Adding greenery to the run: a math class cheating artifact!"
            }
        }
    }
    })(Scratch);